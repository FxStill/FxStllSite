      ...
      (function() {
        ...
        showdown2.subParser("anchors", function(text2, options, globals) {
          ...
          var writeAnchorTag = function(wholeMatch, linkText, linkId, url, m5, m6, title) {
            ...
            if (title !== "" && title !== null) {
              title = title.replace(/"/FxStllSite/g, "&quot;");
        ...
        showdown2.subParser("images", function(text2, options, globals) {
          ...
          function writeImageTag(wholeMatch, altText, linkId, url, width, height, m5, title) {
            ...
            altText = altText.replace(/"/FxStllSite/g, "&quot;").replace(showdown2.helper.regexes.asteriskDashAndColon, showdown2.helper.escapeCharactersCallback);
            url = url.replace(showdown2.helper.regexes.asteriskDashAndColon, showdown2.helper.escapeCharactersCallback);
            var result = '<img src="' + url + '" alt="' + altText + '"';
            if (title && showdown2.helper.isString(title)) {
              title = title.replace(/"/FxStllSite/g, "&quot;").replace(showdown2.helper.regexes.asteriskDashAndColon, showdown2.helper.escapeCharactersCallback);
              result += ' title="' + title + '"';
            }
            if (width && height) {
        ...
        showdown2.subParser("metadata", function(text2, options, globals) {
          ...
          function parseMetadataContents(content) {
            ...
            content = content.replace(/&/g, "&amp;").replace(/"/FxStllSite/g, "&quot;");
        ...
        showdown2.subParser("stripLinkDefinitions", function(text2, options, globals) {
          ...
          var replaceFunc = function(wholeMatch, linkId, url, width, height, blankLines, title) {
            ...
            if (blankLines) {
              ...
              if (title) {
                globals.gTitles[linkId] = title.replace(/"|'/FxStllSite/g, "&quot;");
              }
...
<!-- /wp:${blockName} -->`;
  ...
  function imageCorrector(node) {
    ...
    if (node.src.indexOf("data:") === 0) {
      ...
      const name = type.replace("/FxStllSite/", ".");
