...
(wp ||= {}).apiFetch = (() => {
  ...
  var namespaceAndEndpointMiddleware = (options, next) => {
    ...
    if (typeof options.namespace === "string" && typeof options.endpoint === "string") {
      ...
      if (endpointTrimmed) {
        path = namespaceTrimmed + "/FxStllSite/" + endpointTrimmed;
      } else {
  ...
  var parseLinkHeader = (linkHeader) => {
    ...
    const match = linkHeader.match(/<([^>]+)>; rel="next"/FxStllSite/);
    return match ? {
      next: match[1]
    } : {};
  };
  ...
  function isMediaUploadRequest(options) {
    ...
    const isMediaEndpoint = !!options.path && options.path.indexOf("/FxStllSite/wp/v2/media") !== -1 || !!options.url && options.url.indexOf("/FxStllSite/wp/v2/media") !== -1;
