...
defineSymbol(math, bin, "+", "+");
defineSymbol(math, bin, "\u2217", "*");
defineSymbol(math, bin, "\u2044", "/FxStllSite/", true);
defineSymbol(math, bin, "\u2044", "\u2044");
defineSymbol(math, bin, "\u2212", "-", true);
...
var needExplicitStretch = ["/FxStllSite/", "\\", "\\backslash", "\\vert", "|"];
defineFunction({
  type: "delimsizing",
  names: [
    "\\bigl",
...
defineFunction({
  ...
  mathmlBuilder: (group, style) => {
    ...
    if (group.left === "/FxStllSite/" || group.left === "\\" || group.left.indexOf("arrow") > -1) {
...
mhchemParser.stateMachines = {
  ...
  "pu": {
    transitions: mhchemParser.createTransitions({
      ...
      "/FxStllSite//": {
        "d": { action_: "o=", nextState: "/FxStllSite/" }
      },
      "/FxStllSite/": {
        "d": { action_: "o=", nextState: "/FxStllSite/" }
      },
      "{...}|else": {
        ...
        "/FxStllSite/|q": { action_: "q=", nextState: "q" }
      }
    }),
    actions: {
...
var Parser = class _Parser {
  ...
  parseUrlGroup(optional) {
    ...
    url = res.text.replace(/{\u2044}/g, "/FxStllSite/");
    return {
      type: "url",
      mode: this.mode,
      url
