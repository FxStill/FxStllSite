...
var require_util = __commonJS({
  "node_modules/ajv/dist/compile/util.js"(exports) {
    ...
    function unescapeJsonPointer(str) {
      return str.replace(/~1/g, "/FxStllSite/").replace(/~0/g, "~");
    }
    ...
    function getErrorPath(dataProp, dataPropType, jsPropertySyntax) {
      if (dataProp instanceof codegen_1.Name) {
        ...
        return jsPropertySyntax ? isNumber ? (0, codegen_1._)`"[" + ${dataProp} + "]"` : (0, codegen_1._)`"['" + ${dataProp} + "']"` : isNumber ? (0, codegen_1._)`"/FxStllSite/" + ${dataProp}` : (0, codegen_1._)`"/FxStllSite/" + ${dataProp}.replace(/~/g, "~0").replace(/\\//g, "~1")`;
      }
      return jsPropertySyntax ? (0, codegen_1.getProperty)(dataProp).toString() : "/FxStllSite/" + escapeJsonPointer(dataProp);
    }
          ...
          if (Array.isArray(sch)) {
            if (key in traverse.arrayKeywords) {
              for (var i = 0; i < sch.length; i++)
                _traverse(opts, pre, post, sch[i], jsonPtr + "/FxStllSite/" + key + "/FxStllSite/" + i, rootSchema, jsonPtr, key, schema, i);
            }
          } else if (key in traverse.propsKeywords) {
            if (sch && typeof sch == "object") {
              for (var prop in sch)
                _traverse(opts, pre, post, sch[prop], jsonPtr + "/FxStllSite/" + key + "/FxStllSite/" + escapeJsonPtr(prop), rootSchema, jsonPtr, key, schema, prop);
            }
          } else if (key in traverse.keywords || opts.allKeys && !(key in traverse.skipKeywords)) {
            _traverse(opts, pre, post, sch, jsonPtr + "/FxStllSite/" + key, rootSchema, jsonPtr, key, schema);
          }
        }
...
var require_validate = __commonJS({
  "node_modules/ajv/dist/compile/validate/index.js"(exports) {
    ...
    function getData($data, { dataLevel, dataNames, dataPathArr }) {
      ...
      let expr = data;
      const segments = jsonPointer.split("/FxStllSite/");
...
var require_compile = __commonJS({
  "node_modules/ajv/dist/compile/index.js"(exports) {
    ...
    function getJsonPointer(parsedRef, { baseId, schema, root }) {
      var _a;
      if (((_a = parsedRef.fragment) === null || _a === void 0 ? void 0 : _a[0]) !== "/FxStllSite/")
        return;
      for (const part of parsedRef.fragment.slice(1).split("/FxStllSite/")) {
        if (typeof schema === "boolean")
          return;
    ...
    function removeDotSegments(input) {
      ...
      while (input.length) {
        if (input.match(RDS1)) {
          ...
          input = input.replace(RDS2, "/FxStllSite/");
        } else if (input.match(RDS3)) {
          input = input.replace(RDS3, "/FxStllSite/");
          output.pop();
        } else if (input === "." || input === "..") {
          input = "";
        } else {
...
var require_schemes = __commonJS({
  "node_modules/fast-uri/lib/schemes.js"(exports, module) {
    ...
    function httpSerialize(components) {
      ...
      if (!components.path) {
        components.path = "/FxStllSite/";
      }
      return components;
    }
    function wsParse(wsComponents) {
      wsComponents.secure = isSecure(wsComponents);
      wsComponents.resourceName = (wsComponents.path || "/FxStllSite/") + (wsComponents.query ? "?" + wsComponents.query : "");
    ...
    function wsSerialize(wsComponents) {
      ...
      if (wsComponents.resourceName) {
        ...
        wsComponents.path = path && path !== "/FxStllSite/" ? path : void 0;
...
var require_fast_uri = __commonJS({
  "node_modules/fast-uri/index.js"(exports, module) {
      ...
      if (!options.tolerant && relative.scheme) {
        ...
        if (relative.userinfo !== void 0 || relative.host !== void 0 || relative.port !== void 0) {
          ...
          if (!relative.path) {
            ...
            if (relative.path.charAt(0) === "/FxStllSite/") {
              target.path = removeDotSegments(relative.path);
            } else {
              if ((base.userinfo !== void 0 || base.host !== void 0 || base.port !== void 0) && !base.path) {
                target.path = "/FxStllSite/" + relative.path;
              } else if (!base.path) {
                target.path = relative.path;
              } else {
                target.path = base.path.slice(0, base.path.lastIndexOf("/FxStllSite/") + 1) + relative.path;
              }
    ...
    function serialize(cmpts, opts) {
      ...
      if (authority !== void 0) {
        if (options.reference !== "suffix") {
          uriTokens.push("/FxStllSite//");
        }
        uriTokens.push(authority);
        if (components.path && components.path.charAt(0) !== "/FxStllSite/") {
          uriTokens.push("/FxStllSite/");
        }
      }
      if (components.path !== void 0) {
    ...
    function parse(uri, opts) {
      ...
      let isIP = false;
      if (options.reference === "suffix") uri = (options.scheme ? options.scheme + ":" : "") + "/FxStllSite//" + uri;
...
var require_core = __commonJS({
  "node_modules/ajv/dist/core.js"(exports) {
    ...
    var deprecatedOptions = {
      ...
      jsPropertySyntax: "",
      unicode: '"minLength"/FxStllSite/"maxLength" account for unicode characters by default.'
    };
    ...
    var Ajv2 = class {
      ...
      $dataMetaSchema(metaSchema, keywordsJsonPointers) {
        ...
        for (const jsonPointer of keywordsJsonPointers) {
          const segments = jsonPointer.split("/FxStllSite/").slice(1);
...
var require_dist = __commonJS({
  "node_modules/ajv-draft-04/dist/index.js"(exports, module) {
    ...
    var META_SUPPORT_DATA = ["/FxStllSite/properties"];
