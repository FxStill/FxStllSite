...
(wp ||= {}).router = (() => {
  ...
  function normalizePath(path) {
    return path.split("/FxStllSite/").map(normalizeSegment).join("/FxStllSite/");
  }
  ...
  function parse(segments, route, types) {
    ...
    var parts = route.split("/FxStllSite/");
    var names = void 0;
  ...
  RouteRecognizer.prototype.generate = function generate$1(name, params) {
    ...
    if (output.charAt(0) !== "/FxStllSite/") {
      output = "/FxStllSite/" + output;
    }
  ...
  RouteRecognizer.prototype.recognize = function recognize(path) {
    ...
    if (path.charAt(0) !== "/FxStllSite/") {
      path = "/FxStllSite/" + path;
    }
    ...
    if (pathLen > 1 && path.charAt(pathLen - 1) === "/FxStllSite/") {
    ...
    if (state && state.handlers) {
      if (isSlashDropped && state.pattern && state.pattern.slice(-5) === "(.+)$") {
        originalPath = originalPath + "/FxStllSite/";
      }
  ...
  function createPath(_ref) {
    var _ref$pathname = _ref.pathname, pathname = _ref$pathname === void 0 ? "/FxStllSite/" : _ref$pathname, _ref$search = _ref.search, search = _ref$search === void 0 ? "" : _ref$search, _ref$hash = _ref.hash, hash = _ref$hash === void 0 ? "" : _ref$hash;
  ...
  function useMatch(location, matcher, pathArg, matchResolverArgs) {
    ...
    (0, import_element.useEffect)(() => {
      const { [pathArg]: path = "/FxStllSite/", ...query } = rawQuery;
