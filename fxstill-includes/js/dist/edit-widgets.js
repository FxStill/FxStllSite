...
(wp ||= {}).editWidgets = (() => {
  ...
  function ComplementaryAreaToggle({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      ComponentToUse,
      {
        ...
        "aria-controls": identifier.replace("/FxStllSite/", ":"),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
        ComplementaryAreaFill,
        {
          ...
          scope,
          id: identifier.replace("/FxStllSite/", ":"),
          children: [
  ...
  import_api_fetch.default.use(function(options, next) {
    if (options.path?.indexOf("/FxStllSite/wp/v2/types/widget-area") === 0) {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
            ShortcutCategorySection,
            {
              ...
              additionalShortcuts: [
                {
                  keyCombination: { character: "/FxStllSite/" },
                  description: (0, import_i18n14.__)(
                    "Change the block type after adding a new paragraph."
                  ),
                  /* translators: The forward-slash character. e.g. '/FxStllSite/'. */
                ...
                ),
                {
                  InserterIconImage: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
                    "img",
                    {
                      ...
                      src: "data:image/svg+xml,%3Csvg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='18' height='18' rx='2' fill='%231E1E1E'/FxStllSite/%3E%3Cpath d='M9.22727 4V14M4 8.77273H14' stroke='white' stroke-width='1.5'/FxStllSite/%3E%3C/svg%3E%0A"
                    }
                  )
                }
              ) })
