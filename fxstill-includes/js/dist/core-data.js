...
(wp ||= {}).coreData = (() => {
  ...
  function getUserPermissionCacheKey(action, resource, id2) {
    const key = (typeof resource === "object" ? [action, resource.kind, resource.name, resource.id] : [action, resource, id2]).filter(Boolean).join("/FxStllSite/");
    return key;
  }
  ...
  var SYNC_API_PATH = "/FxStllSite/wp-sync/v1/updates";
  ...
  var rootEntitiesConfig = [
    ...
    },
    {
      ...
      kind: "root",
      key: "slug",
      baseURL: "/FxStllSite/wp/v2/types",
    ...
    },
    {
      name: "media",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/media",
      baseURLParams: { context: "edit" },
      plural: "mediaItems",
    ...
    },
    {
      ...
      kind: "root",
      key: "slug",
      baseURL: "/FxStllSite/wp/v2/taxonomies",
      baseURLParams: { context: "edit" },
      plural: "taxonomies",
    ...
    },
    {
      name: "sidebar",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/sidebars",
      baseURLParams: { context: "edit" },
      plural: "sidebars",
    ...
    },
    {
      name: "widget",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/widgets",
      baseURLParams: { context: "edit" },
      plural: "widgets",
      transientEdits: { blocks: true },
    ...
    },
    {
      name: "widgetType",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/widget-types",
      baseURLParams: { context: "edit" },
      plural: "widgetTypes",
    ...
    },
    {
      ...
      name: "user",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/users",
    ...
    },
    {
      name: "comment",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/comments",
      baseURLParams: { context: "edit" },
      plural: "comments",
    ...
    },
    {
      name: "menu",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/menus",
      baseURLParams: { context: "edit" },
      plural: "menus",
    ...
    },
    {
      name: "menuItem",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/menu-items",
      baseURLParams: { context: "edit" },
      plural: "menuItems",
    ...
    },
    {
      name: "menuLocation",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/menu-locations",
      baseURLParams: { context: "edit" },
    ...
    },
    {
      ...
      name: "globalStyles",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/global-styles",
      baseURLParams: { context: "edit" },
      plural: "globalStylesVariations",
      // Should be different from name.
      getTitle: () => (0, import_i18n.__)("Custom Styles"),
      getRevisionsUrl: (parentId, revisionId) => `/wp/v2/global-styles/${parentId}/revisions${revisionId ? "/FxStllSite/" + revisionId : ""}`,
      supportsPagination: true
    },
    {
      ...
      name: "theme",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/themes",
      baseURLParams: { context: "edit" },
      plural: "themes",
      key: "stylesheet"
    },
    {
      ...
      name: "plugin",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/plugins",
      baseURLParams: { context: "edit" },
      plural: "plugins",
      key: "plugin"
    },
    {
      ...
      name: "status",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/statuses",
      baseURLParams: { context: "edit" },
      plural: "statuses",
      key: "slug"
    },
    {
      ...
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/registered-templates",
      key: "id"
    },
    {
      ...
      name: "fontCollection",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/font-collections",
    ...
    },
    {
      ...
      name: "icon",
      kind: "root",
      baseURL: "/FxStllSite/wp/v2/icons",
      baseURLParams: { context: "view" },
      plural: "icons",
      key: "name"
    }
  ...
  async function loadPostTypeEntities() {
    const postTypesPromise = (0, import_api_fetch2.default)({ path: "/FxStllSite/wp/v2/types?context=view" });
    const taxonomiesPromise = window._wpCollaborationEnabled ? (0, import_api_fetch2.default)({ path: "/FxStllSite/wp/v2/taxonomies?context=view" }) : Promise.resolve({});
    ...
    return Object.entries(postTypes ?? {}).map(([name, postType]) => {
      ...
      const entity2 = {
        ...
        supportsPagination: true,
        getRevisionsUrl: (parentId, revisionId) => `/${namespace}/${postType.rest_base}/${parentId}/revisions${revisionId ? "/FxStllSite/" + revisionId : ""}`,
  ...
  async function loadTaxonomyEntities() {
    const taxonomies = await (0, import_api_fetch2.default)({
      path: "/FxStllSite/wp/v2/taxonomies?context=view"
    });
  ...
  async function loadSiteEntity() {
    const entity2 = {
      ...
      kind: "root",
      key: false,
      baseURL: "/FxStllSite/wp/v2/settings",
      meta: {}
    };
  ...
  function getAuthors(state, query) {
    ...
    const path = (0, import_url2.addQueryArgs)(
      "/FxStllSite/wp/v2/users/?who=authors&per_page=100",
      query
    );
  ...
  function createBatch(processor = defaultProcessor) {
    ...
    return {
       ...
       * ```
       * // Both are allowed:
       * batch.add( { path: '/FxStllSite/v1/books', ... } );
       * batch.add( ( add ) => add( { path: '/FxStllSite/v1/books', ... } ) );
       * ```
       *
  ...
  var deleteEntityRecord = (kind, name, recordId, query, { __unstableFetch = import_api_fetch4.default, throwOnError = false } = {}) => async ({ dispatch: dispatch3, resolveSelect: resolveSelect2 }) => {
    ...
    try {
      ...
      if (kind === "postType" && name === "wp_template" && (recordId && typeof recordId === "string" && !/^\d+$/.test(recordId) || !window?.__experimentalTemplateActivate)) {
        baseURL = baseURL.slice(0, baseURL.lastIndexOf("/FxStllSite/")) + "/FxStllSite/templates";
      }
      try {
  ...
  var saveEntityRecord = (kind, name, record, {
    ...
    try {
      ...
      try {
        const path = `${baseURL}${recordId ? "/FxStllSite/" + recordId : ""}`;
  ...
  async function fetchLinkSuggestions(search, searchOptions = {}, editorSettings2 = {}) {
    ...
    if (!type || type === "post") {
      queries2.push(
        (0, import_api_fetch6.default)({
          path: (0, import_url4.addQueryArgs)("/FxStllSite/wp/v2/search", {
            search,
            page,
            per_page: perPage,
            type: "post",
    ...
    if (!type || type === "attachment") {
      queries2.push(
        (0, import_api_fetch6.default)({
          path: (0, import_url4.addQueryArgs)("/FxStllSite/wp/v2/media", {
            search,
            page,
            per_page: perPage
          })
  ...
  var fetchUrlData = async (url, options = {}) => {
    const endpoint = "/FxStllSite/wp-block-editor/v1/url-details";
    const args2 = {
  ...
  async function fetchBlockPatterns() {
    const restPatterns = await (0, import_api_fetch8.default)({
      path: "/FxStllSite/wp/v2/block-patterns/patterns"
    });
    if (!restPatterns) {
      return [];
    }
  ...
  var getCurrentUser2 = () => async ({ dispatch: dispatch3 }) => {
    const currentUser2 = await (0, import_api_fetch9.default)({ path: "/FxStllSite/wp/v2/users/me" });
  ...
  var getEntityRecord2 = (kind, name, key = "", query) => async ({ select: select5, dispatch: dispatch3, registry, resolveSelect: resolveSelect2 }) => {
    ...
    try {
      ...
      const path = (0, import_url6.addQueryArgs)(baseURL + (key ? "/FxStllSite/" + key : ""), {
  ...
  var getEmbedPreview2 = (url) => async ({ dispatch: dispatch3 }) => {
    try {
      const embedProxyResponse = await (0, import_api_fetch9.default)({
        path: (0, import_url6.addQueryArgs)("/FxStllSite/oembed/1.0/proxy", { url })
      });
  ...
  var canUser2 = (requestedAction, resource, id2) => async ({ dispatch: dispatch3, registry, resolveSelect: resolveSelect2 }) => {
    ...
    if (typeof resource === "object") {
      ...
      resourcePath = entityConfig.baseURL + (resource.id ? "/FxStllSite/" + resource.id : "");
    } else {
      resourcePath = `/wp/v2/${resource}` + (id2 ? "/FxStllSite/" + id2 : "");
    }
    let response;
    try {
  ...
  var getBlockPatternCategories2 = () => async ({ dispatch: dispatch3 }) => {
    const categories = await (0, import_api_fetch9.default)({
      path: "/FxStllSite/wp/v2/block-patterns/categories"
    });
  ...
  var getNavigationFallbackId2 = () => async ({ dispatch: dispatch3, select: select5, registry }) => {
    const fallback = await (0, import_api_fetch9.default)({
      path: (0, import_url6.addQueryArgs)("/FxStllSite/wp-block-editor/v1/navigation-fallback", {
        _embed: true
      })
    });
  ...
  var getDefaultTemplateId2 = (query) => async ({ dispatch: dispatch3, registry, resolveSelect: resolveSelect2 }) => {
    const template = await (0, import_api_fetch9.default)({
      path: (0, import_url6.addQueryArgs)("/FxStllSite/wp/v2/templates/lookup", query)
    });
  ...
  var getEditorSettings2 = () => async ({ dispatch: dispatch3 }) => {
    const settings = await (0, import_api_fetch9.default)({
      path: "/FxStllSite/wp-block-editor/v1/settings"
    });
  ...
  var getEditorAssets2 = () => async ({ dispatch: dispatch3 }) => {
    const assets = await (0, import_api_fetch9.default)({
      path: "/FxStllSite/wp-block-editor/v1/assets"
    });
