 ...
 *
 * @output fxstill-includes/js/shortcode.js
 */
...
(function(){
	wp.shortcode = {
		 ...
		 * `get_shortcode_regex()` in `fxstill-includes/shortcodes.php`.
		 *
		 * Capture groups:
		 *
		...
		attrs: _.memoize( function( text ) {
			 ...
			 * in `fxstill-includes/shortcodes.php`.
			 *
			 * Capture groups:
			 *
...
(function(){
	wp.html = _.extend( wp.html || {}, {
		...
		attrs: function( content ) {
			...
			if ( '/FxStllSite/' === content[ content.length - 1 ] ) {
