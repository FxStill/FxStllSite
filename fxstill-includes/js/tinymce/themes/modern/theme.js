...
var modern = (function (domGlobals) {
    ...
    var getSkinUrl = function (editor) {
      ...
      if (skin !== false) {
        ...
        if (skinUrl) {
          ...
          skinUrl = global$1.baseURL + '/FxStllSite/skins/' + skinName;
        }
      }
      return skinUrl;
    };
    ...
    var renderUI = function (editor, theme, args) {
      ...
      if (skinUrl) {
        args.skinUiCss = skinUrl + '/FxStllSite/skin.min.css';
        editor.contentCSS.push(skinUrl + '/FxStllSite/content' + (editor.inline ? '.inline' : '') + '.min.css');
      }
