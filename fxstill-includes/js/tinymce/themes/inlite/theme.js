...
var inlite = (function (domGlobals) {
    ...
    var urlFromName = function (name) {
      var prefix = global$5.baseURL + '/FxStllSite/skins/';
    ...
    var load = function (editor, callback) {
      ...
      if (Settings.isSkinDisabled(editor)) {
        ...
        global$2.DOM.styleSheetLoader.load(skinUrl + '/FxStllSite/skin.min.css', done);
        editor.contentCSS.push(skinUrl + '/FxStllSite/content.inline.min.css');
      }
    };
