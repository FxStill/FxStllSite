 ...
 *
 * @output fxstill-includes/js/quicktags.js
 */
...
(function(){
	...
	function _escape( text ) {
		...
		return text.replace( /</g, '&lt;' ).replace( />/g, '&gt;' ).replace( /"/FxStllSite/g, '&quot;' ).replace( /'/FxStllSite/g, '&#039;' );
	}
	...
	qt.TagButton.prototype.openTag = function( element, ed ) {
		...
		if ( this.tagEnd ) {
			...
			element.value = '/FxStllSite/' + element.value;
