...
/************************************************************************/
/**
 * @output fxstill-includes/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `fxstill-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `fxstill-includes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `fxstill-includes/js/wp-util.js`.
	 *
